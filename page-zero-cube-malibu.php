...
<section id="date" class="item_left" style="opacity: 1; left: 0px;">
	<div class="content">
		...
		<dl>
			...
			<dd>
				<div class="day">1.
					<i class="blue">13<span class="fcs"><span class="vt">[</span>Sat<span class="vt">]</span></span></i>
					<i class="red">14<span class="fcs"><span class="vt">[</span>Sun<span class="vt">]</span></span></i>
				<div class="time"><span>START</span>10:00／13:00／16:00</div>
				<div class="reservation"><a href="#contact" class="scroll"><span>
					見学会予約はこちら
					</span></a></div>
			</div></dd>
		</dl>
